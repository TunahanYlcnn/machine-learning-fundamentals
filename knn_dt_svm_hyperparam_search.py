# Açıklama: Bu kod, Iris veri setinde KNN, Decision Tree ve SVM sınıflandırma modellerini uygular. 
# GridSearchCV ve RandomizedSearchCV ile en iyi hiperparametreleri bulur ve doğruluk skorlarını ekrana yazdırır.
