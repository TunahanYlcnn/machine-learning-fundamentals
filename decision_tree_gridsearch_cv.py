# Açıklama: Bu kod, Iris veri setinde Decision Tree sınıflandırma modeli uygular ve GridSearchCV kullanarak farklı max_depth ve max_leaf_nodes değerleri için çapraz doğrulama ile en iyi hiperparametreleri bulur. 
# Ayrıca her fold için doğruluk skorlarını ve ortalama test skorlarını listeler.
...
# Ortalama test skoru ve parametreler
...
# Her fold için detaylı doğruluklar
