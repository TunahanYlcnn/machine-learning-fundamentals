# 🔹 Açıklama: Bu kod, farklı sınıflandırma algoritmalarını (KNN, SVM, Karar Ağacı, Rastgele Orman, Naive Bayes) üç farklı veri kümesi üzerinde karşılaştırır ve karar sınırlarını görselleştirir.
# 🔹 Gerekli pip paketleri: pip install scikit-learn matplotlib numpy
